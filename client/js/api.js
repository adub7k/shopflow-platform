...
const db = {
  ...
  revenue:       { get: () => apiFetch('/revenue'), month: (ym) => apiFetch('/revenue/month/'+ym) },
  ...
  quotes:        { all: () => apiFetch('/quotes'), get: (id) => apiFetch('/quotes/'+id), save: (q) => apiFetch('/quotes',{method:'POST',body:q}), delete: (id) => apiFetch('/quotes/'+id,{method:'DELETE'}), send: (id) => apiFetch('/quotes/'+id+'/send',{method:'POST'}), sendEmail: (id) => apiFetch('/quotes/'+id+'/send-email',{method:'POST'}), paymentLink: (id) => apiFetch('/square/quote-payment-link',{method:'POST',body:{quoteId:id}}) },
